            ...
            <div class="relative w-10 h-10 overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600">
                @if(empty(auth()->user()->avatar))
                    <svg fill="currentColor" viewBox="0 0 20 20"
                         class="w-6 h-6 mx-auto mt-2 text-gray-500 dark:text-gray-400 group-hover:text-red-600 dark:group-hover:text-red-500 {{ bottom_on_if(['my_pins', 'saves', 'profile', 'settings']) }} transition-colors"
