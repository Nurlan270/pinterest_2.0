...
@section('content')
    ...
    <div class="container mx-auto px-5 py-2 mb-24 lg:px-14 lg:py-5">
        <div id="pins-container" class="columns-2 md:columns-3 lg:columns-4 xl:columns-6 gap-4">
    ...
    @pushonce('script')
        <script>
            let nextPageUrl = '{{ $pins->nextPageUrl() }}';
            let loading = false;
            ...
            window.onscroll = function () {
                if (window.innerHeight + window.scrollY >= document.body.offsetHeight - 100 && !loading && nextPageUrl) {
                    ...
                    fetch(nextPageUrl, {
                        ...
                        .then(data => {
                            if (data.html) {
                                // Append the new pins to the pins container
